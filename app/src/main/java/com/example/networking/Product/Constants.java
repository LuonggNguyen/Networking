...
public class Constants {
    public static String url_all_products =
            "http://192.168.1.8:8080/Lab5/get_all_product.php";
    public static String url_create_products =
            "http://192.168.1.8:8080/Lab5/create_product.php";
    public static String url_product_detail =
            "http://192.168.1.8:8080/Lab5/get_product_detail.php";
    public static String url_update_product =
            "http://192.168.1.8:8080/Lab5/update_product.php";
    public static String url_delete_product =
            "http://192.168.1.8:8080/Lab5/delete_product.php";
    // JSON Node names
